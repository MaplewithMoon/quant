...
| 文档 | 内容 |
|---|---|
| [`AGENTS.md`](AGENTS.md) | **协作约定**：环境准备、数据层规矩、提交规矩（自动化助手与新人必读） |
| [`docs/已知问题与待办汇总.md`](docs/已知问题与待办汇总.md) | 全项目已知问题 / 局限 / 待办，以及每轮的修复记录 |
...
> ⚠️ `python scripts/validate_data.py --check all` 是**几十分钟**量级
> （要扫 7 万+ 文件 / 5,889 只股票），日常请用针对性单项目检查，
> 详见 [`AGENTS.md`](AGENTS.md) 第 1 节。
